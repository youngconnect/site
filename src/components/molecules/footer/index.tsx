        ...
        <footer className="@container">
            <div className="py-10 space-y-8 border-t border-t-gray-700">
                <div className="container mx-auto space-y-14">
                    <div className="flex justify-between items-center flex-col @min-lg:flex-row gap-y-8 px-5 @min-lg:px-0">
                        <div className="flex-center gap-3">
                            <LogoApp size={"45"} />
                            <span className="text-headline-24 text-[1.15rem] text-foreground">{Env.NEXT_PUBLIC_APP_NAME}</span>
                        </div>

                        <Divider  className="block @min-lg:hidden"/>
                    ...
                    <Divider className="hidden @min-lg:block" />
                    
                    <div className="flex justify-between items-center @min-lg:items-start flex-col @min-lg:flex-row gap-y-5 px-5 @min-lg:px-0">
                        <ul className="flex items-center flex-col @min-lg:flex-row gap-3 w-full">
                            {
